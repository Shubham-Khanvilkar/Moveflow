...
import {
  View, Text, StyleSheet, TouchableOpacity, SafeAreaView, Alert, Dimensions, ScrollView,
...
export default function EmployeeTrackingScreen({ navigation, route }: any) {
  const { user, token } = useAuth();
  const [trackingMode, setTrackingMode] = useState<'cab' | 'shuttle' | 'guard'>('cab');
