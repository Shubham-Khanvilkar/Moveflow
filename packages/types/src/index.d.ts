export type UserRole = 'SUPER_ADMIN' | 'COMPANY_ADMIN' | 'TRANSPORT_ADMIN' | 'DISPATCHER' | 'MANAGER' | 'TEAM_LEADER' | 'EMPLOYEE' | 'DRIVER' | 'GUARD';
...
export type BookingStatus = 'REQUESTED' | 'PENDING_APPROVAL' | 'APPROVED' | 'REJECTED' | 'DISPATCHING' | 'ASSIGNED' | 'DRIVER_CONFIRMED' | 'EN_ROUTE' | 'ARRIVED' | 'BOARDING' | 'IN_PROGRESS' | 'COMPLETED' | 'CANCELLED' | 'NO_SHOW' | 'EXPIRED';
...
export type TripStatus = 'SCHEDULED' | 'DISPATCHED' | 'DRIVER_ACCEPTED' | 'EN_ROUTE_TO_PICKUP' | 'ARRIVED_AT_PICKUP' | 'BOARDING' | 'IN_TRANSIT' | 'ARRIVED_AT_DROP' | 'COMPLETED' | 'CANCELLED' | 'DELAYED';
...
export type IncidentType = 'ACCIDENT' | 'VEHICLE_BREAKDOWN' | 'DRIVER_ISSUE' | 'PASSENGER_ISSUE' | 'GPS_FAILURE' | 'ROUTE_BLOCKED' | 'SECURITY' | 'OTHER';
...
export type NotificationType = 'BOOKING_CONFIRMED' | 'BOOKING_APPROVED' | 'BOOKING_REJECTED' | 'DRIVER_ASSIGNED' | 'VEHICLE_APPROACHING' | 'VEHICLE_ARRIVED' | 'TRIP_DELAYED' | 'TRIP_COMPLETED' | 'BOOKING_CANCELLED' | 'SOS_ALERT' | 'SYSTEM' | 'COST_ALERT';
...
export type WSEventType = 'vehicle.location' | 'vehicle.online' | 'vehicle.offline' | 'trip.started' | 'trip.arrived' | 'trip.boarding' | 'trip.completed' | 'trip.cancelled' | 'trip.updated' | 'booking.updated' | 'geofence.entered' | 'geofence.exited' | 'sos.created' | 'sos.acknowledged' | 'notification.new' | 'incident.new';
